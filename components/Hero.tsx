...
export default function Hero() {
    ...
    useLayoutEffect(() => {
        ...
        tl.fromTo(socialRef.current, { x: -50, opacity: 0 }, { x: 0, opacity: 1, delay: 0.5 })
    ...
    return (
        <section ref={heroRef} className="relative min-h-screen pt-40 pb-24 px-6 lg:px-12 bg-stadium-hero bg-cover bg-center flex items-center overflow-hidden">
            ...
            <div className="container mx-auto relative px-8 lg:px-16 z-10">
                ...
                <div ref={socialRef} className="absolute top-0 -left-12 hidden 2xl:flex flex-col space-y-6 items-center">
                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div ref={cardRef} className="lg:justify-self-end w-full max-w-sm relative z-10 group">
